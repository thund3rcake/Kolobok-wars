...
QT_MOC_LITERAL(3, 17, 9) // "newPacket"

    },
    "UdpServer\0error\0\0newPacket"
};
...
void UdpServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (UdpServer::*_t)(int , QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&UdpServer::error)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (UdpServer::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&UdpServer::newPacket)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject UdpServer::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_UdpServer.data,
...
// SIGNAL 0
void UdpServer::error(int _t1, QString _t2)
{
