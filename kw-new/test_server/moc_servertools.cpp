...
struct qt_meta_stringdata_ServerTools_t {
    QByteArrayData data[3];
    char stringdata0[29];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_ServerTools_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ServerTools_t qt_meta_stringdata_ServerTools = {
    {
QT_MOC_LITERAL(0, 0, 11), // "ServerTools"
QT_MOC_LITERAL(1, 12, 15), // "setNewUdpPacket"
QT_MOC_LITERAL(2, 28, 0) // ""

    },
    "ServerTools\0setNewUdpPacket\0"
};
...
const QMetaObject ServerTools::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ServerTools.data,
      qt_meta_data_ServerTools,  qt_static_metacall, nullptr, nullptr}
};
...
void *ServerTools::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ServerTools.stringdata0))
