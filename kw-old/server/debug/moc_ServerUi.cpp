...
static const char qt_meta_stringdata_ServerUi[] = {
    "ServerUi\0\0onStart()\0onStop()\0"
};
...
const QMetaObjectExtraData ServerUi::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject ServerUi::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ServerUi,
      qt_meta_data_ServerUi, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &ServerUi::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ServerUi))
